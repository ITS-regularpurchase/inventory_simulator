...
if check_password():
    ...
    pn_list = data.rio_items['pn'].head(300)
    ...
    with col1:
        with st.form("my_form"):
            ...
            values = st.slider('Select a range of values', min_3_year_movement, max_3_year_movement , (min_3_year_movement, max_3_year_movement))
